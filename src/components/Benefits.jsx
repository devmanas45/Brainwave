                ...
                <div className="flex flex-wrap gap-10 mb-10">
                    {benefits.map((item)=>(
                        <div className='block relative p-0.5 bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem]' style={{backgroundImage:`url(${item.backgroundUrl})`}} key={item.id}>
                            ...
                            <div className="absolute inset-0.5 bg-n-8" style={{clipPath:"url(#benefits"}}> {/*clippath*/}
                                <div className="absolute inset-0 opacity-0 transition-opacity hover:opacity-10">{/*Inset*/}
                                    {item.imageUrl && (
