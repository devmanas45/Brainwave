  ...
  return (
    <Section className='overflow-hidden' id='pricing'>
        <div className="container relative z-2">
            ...
            <div className='flex justify-center mt-10'><Link to='/pricing' className='text-xs font-code font-bold tracking-wider uppercase border-b'>See the full details.</Link></div>
        </div>
    </Section>
  )
}
