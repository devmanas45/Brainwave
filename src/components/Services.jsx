    ...
    <Section id="how-to-use">
        <div className='container'>
            ...
            <div className='relative'>
                <div className='relative z-1 flex items-center h-[39rem] mb-5 p-8 rounded-3xl overflow-hidden border border-n-1/10 lg:p-20 xl:h-[46rem]'>
                    <div className='absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto'>
                        <img src={service1} className='w-full h-full object-cover md:object-right' width={800} height={730} alt="smartestAI" />
                    </div>
                    <div className='relative z-1 max-w-[17rem] ml-auto'>
                        ...
                        <ul className='body-2'> 
                            {brainwaveServices.map((item,idx)=>(
                                <li className='flex items-start py-4 border-t border-n-6' key={idx}>
                                    <img src={check} alt="" />
                ...
                <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                    <div className="relative min-h-[39rem] border border-n-1/10 rounded-xl overflow-hidden" >
                    ...
                    <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                        <div className='py-12 px-4 xl:px-8'>
                            ...
                            <p className='body-2 mt-[2rem] text-n-3'>
                                The World's most
                                powerful AI photo and video art
